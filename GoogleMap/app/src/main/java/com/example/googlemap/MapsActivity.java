...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isLocationPermissionGranted()){
            ...
            try {
                listGeoCoder = new Geocoder(this).getFromLocationName("Daganbhuiyan Zero Point, Feni - Noakhali Highway, Ramnagar", 1);
            } catch (Exception e) {
                e.printStackTrace();
            }

            double logitude = listGeoCoder.get(0).getLatitude();
