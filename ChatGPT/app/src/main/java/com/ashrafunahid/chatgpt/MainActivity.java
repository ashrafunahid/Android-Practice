package com.ashrafunahid.chatgpt;
...
import com.ashrafunahid.chatgpt.Adapters.MessageAdapter;
import com.ashrafunahid.chatgpt.Constants.Constants;
import com.ashrafunahid.chatgpt.Models.MessageModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void callAPI(String question) {
        ...
        Request request = new Request.Builder()
                ...
                .header("Authorization","Bearer "+Constants.API)
                .post(requestBody)
                .build();
