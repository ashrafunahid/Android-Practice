...
public class PhotoUpscale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photo_upscale);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImagePicker.with(PhotoUpscale.this)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            new PhotoUpscale.UploadImage(imageUri).execute();
    ...
    public class UploadImage extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            CommonUtil.loadProgressDialog(PhotoUpscale.this);
        }
...
//            MediaType mediaType = MediaType.parse("image/png");
            ...
            try {
                responseText = NetworkUtil.postRun(requestBody, CommonUtil.BASE_URL + "upscale");
