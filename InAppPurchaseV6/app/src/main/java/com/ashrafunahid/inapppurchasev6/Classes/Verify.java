package com.ashrafunahid.inapppurchasev6.Classes;
...
public class Verify {
    ...
    public static PublicKey generatePublicKey(String encodePublicKey) throws IOException {
        try{
            byte[] decodeKey = Base64.decode(encodePublicKey, Base64.DEFAULT);
